...
public class PipeParam {
	...
	/** If the value is empty, it means it is compatible with all */
	private List<DATA_SOURCE_TYPE> writeToType = new ArrayList<>();
	...
	/** If the value is empty, it means it is compatible with all */
	private List<DATA_SOURCE_TYPE> readFromType = new ArrayList<>();
	...
	/**
	 * default is real pipe,if is virtual will only manage pipe-end with no data
	 * flow!
	 */
	...
	public List<DATA_SOURCE_TYPE> getReadFromType() {
		return readFromType;
	}
	...
	public List<DATA_SOURCE_TYPE> getWriteToType() {
		return writeToType;
	}
	...
	public void setWriteTo(String writeTo, String type) {
		this.writeTo = writeTo; 
		for(String s:type.split(",")) {
			this.writeToType.add(WarehouseParam.getTypeFromString(s));
		}
	}
	...
	public void setReadFrom(String readFrom,String type) {
		this.readFrom = readFrom;
		for(String s:type.split(",")) {
			this.readFromType.add(WarehouseParam.getTypeFromString(s));
		}
	}
